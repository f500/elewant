...
final class Breed
{
    ...
    public const BLACK_SITEGROUND_REGULAR = 'BLACK_SITEGROUND_REGULAR';
    ...
    public const BLACK_UPINSIDE_REGULAR = 'BLACK_UPINSIDE_REGULAR';
    ...
    public const BLUE_INPHPINITY_REGULAR = 'BLUE_INPHPINITY_REGULAR';
    public const BLUE_JOKER_REGULAR = 'BLUE_JOKER_REGULAR';
    ...
    public const BROWN_SYLIUS_REGULAR = 'BROWN_SYLIUS_REGULAR';
    ...
    public const GRAY_SYMFONY_REGULAR = 'GRAY_SYMFONY_REGULAR';
    public const GRAY_SYMFONY_15_REGULAR = 'GRAY_SYMFONY_15_REGULAR';
    ...
    public const MULTICOLORED_PHPDAY_REGULAR = 'MULTICOLORED_PHPDAY_REGULAR';
    ...
    public const PINK_PHPCLASSES_REGULAR = 'PINK_PHPCLASSES_REGULAR';
    ...
    public const RED_PHPCON_POLAND_REGULAR = 'RED_PHPCON_POLAND_REGULAR';
    ...
    public const WHITE_PHPCON_JAPAN_REGULAR = 'WHITE_PHPCON_JAPAN_REGULAR';
    public const WHITE_PHPERS_REGULAR = 'WHITE_PHPERS_REGULAR';
    ...
    public const BLUE_INPHPINITY_LARGE = 'BLUE_INPHPINITY_LARGE';
    public const BLUE_JOKER_LARGE = 'BLUE_JOKER_LARGE';
    ...
    public const GRAY_SYMFONY_15_LARGE = 'GRAY_SYMFONY_15_LARGE';
    ...
    public const WHITE_PHPCON_JAPAN_LARGE = 'WHITE_PHPCON_JAPAN_LARGE';
